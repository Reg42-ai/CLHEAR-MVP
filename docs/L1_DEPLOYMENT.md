...
For the current incident, the active selection is `l1-35433640762-1`, the plan
emitted by the #39 recovery apply of 19 Sep 2026 (verify exited 2, publish 0,
then the viewer health probe returned 503: the 3.4 GB candidate no longer fit
the 4096 MiB /tmp beside a partial init download; the viewer is now 6144 MiB /
...
The earlier selections `l1-35427436860-1` (`:21`), `l1-35382351183-1` (`:18`), `l1-35341410131-1` (`:14`),
