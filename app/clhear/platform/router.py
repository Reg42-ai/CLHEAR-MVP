...
SEED_QUALITY: dict[tuple[str, str], float] = {
    ...
    ("l2.consolidate", CLAUDE_SONNET): 0.94,
    ("l2.change", GPT_OSS_120B): 0.91,
    ("l3.block_generate", CLAUDE_SONNET): 0.93,
    ...
    ("l6.rationale", CLAUDE_SONNET): 0.92,
    ("l7.narrative", GPT_OSS_120B): 0.89,
    ("l7.link", GPT_OSS_120B): 0.90,
    ("l8.fill", CLAUDE_SONNET): 0.90,
    ("l0.revalidate", CLAUDE_SONNET): 0.93,
    ("l0.revalidate", CLAUDE_OPUS): 0.97,
    ("eval.judge", NOVA_LITE): 0.86,
    ("l2.review", CLAUDE_SONNET): 0.93,
}
